...
contract TheGraphDataKovan is ChainlinkClient {
    ...
    function requesTheGraphData(address _oracle,  string memory  _jobId) public {
    	Chainlink.Request memory req = buildChainlinkRequest(stringToBytes32(_jobId), address(this), this.fulfillEthereumData.selector);
     ...
     * Callback function
     */
    function fulfillEthereumData(bytes32 _requestId, bytes32 _data) public recordChainlinkFulfillment(_requestId) {
    	data = _data;
    }
